...
@section('title', "Add New Notice - ".$settings->short_title)
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route("admin.notices.add") }}">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="body" id="summernote" class="form-control" placeholder="Enter notice content"></textarea>
                    </div>
                    <div class="mb-3">
