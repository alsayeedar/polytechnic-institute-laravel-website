...
@section('title', "Header Menu - ".$settings->short_title)

@section('content')
<h1 class="mt-4">Header Menu</h1>
<ol class="breadcrumb mb-4">
    <li class="breadcrumb-item active"><a href="{{ route("admin.dashboard") }}">Dashboard</a></li>
    <li class="breadcrumb-item active">Header Menu</li>
</ol>
<form method="POST" action="{{ route("admin.menus.header") }}">
    @csrf
...
<script>
   var itemTextInput = document.getElementById("txtText"),
	...
	var menuEditor = new MenuEditor('element-id', { maxLevel: 1 });
    var nestedData = {!! $menu !!}
